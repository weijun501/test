...
//            }
            ...
            if (!initProcessL(app)) {
                ...
                app.pid = getPid(BBoxCore.getContext(), StubManifest.getProcessName(app.vpid));
            }
        }
        return app;
    }
    ...
    private int getUsingVPidL() {
        ActivityManager manager = (ActivityManager) BBoxCore.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public void restartProcess(String packageName, String processName, int userId) {
        synchronized (mProcessLock) {
            ...
            if (app == null) {
                String stubProcessName = getProcessName(BBoxCore.getContext(), callingPid);
