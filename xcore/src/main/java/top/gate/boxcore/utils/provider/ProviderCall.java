package top.gate.boxcore.utils.provider;
...
import top.gate.boxcore.utils.compat.ContentProviderCompat;
...
public class ProviderCall {
    public static Bundle callSafely(String authority, String methodName, String arg, Bundle bundle) {
        try {
            return call(authority, BBoxCore.get().getContext(), methodName, arg, bundle, 5);
