...
import top.gate.boxcore.server.am.IBActivityManagerService;
...
public class BActivityManager {
    ...
    private IBActivityManagerService getService() {
        ...
        mService = IBActivityManagerService.Stub.asInterface(BBoxCore.get().getService(ServiceManager.ACTIVITY_MANAGER));
        return getService();
    }
}
