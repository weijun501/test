...
import top.gate.boxcore.client.hook.delegate.ServiceConnectionDelegate;
import top.gate.boxcore.client.stub.StubActivity;
...
public class ActivityManagerStub extends ClassInvocationStub {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Exception {
            ...
            if (auth instanceof String) {
                ...
                if (auth.equals("settings") || auth.equals("media") || auth.equals("telephony")) {
                    ...
                    ProviderInfo providerInfo = BBoxCore.getBPackageManager().resolveContentProvider((String) auth, GET_META_DATA, BClient.getUserId());
                        ...
                        if (invoke != null) {
                            ...
                            if (provider != null && !(provider instanceof Proxy)) {
                                Reflector.with(invoke)
                                        .field("provider")
                                        .set(new ContentProviderStub().wrapper((IInterface) provider, BBoxCore.getHostPkg()));
                            }
                        }
                        return invoke;
                    }
                    ...
                    if (BClient.getVPid() != -1) {
                        ClientConfig clientConfig = BBoxCore.getBActivityManager().initProcess(providerInfo.packageName, providerInfo.processName, BClient.getUserId());
                        if (clientConfig.vpid != BClient.getVPid()) {
                            providerBinder = BBoxCore.getBActivityManager().acquireContentProviderClient(providerInfo);
                        }
    ...
    static class StartService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = BBoxCore.getBPackageManager().resolveService(intent, 0, resolvedType, BClient.getUserId());
            if (resolveInfo == null) {
                return method.invoke(who, args);
            }
            return BBoxCore.getBActivityManager().startService(intent, resolvedType, BClient.getUserId());
        }
    }
    ...
    static class StopService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Intent intent = (Intent) args[1];
            String resolvedType = (String) args[2];
            return BBoxCore.getBActivityManager().stopService(intent, resolvedType, BClient.getUserId());
        }
    }
    ...
    static class BindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (resolveInfo != null || ClientSystemEnv.isOpenPackage(intent.getComponent())) {
                Intent proxyIntent = BBoxCore.getBActivityManager().bindService(intent,
    ...
    static class UnbindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            BBoxCore.getBActivityManager().unbindService(iServiceConnection.asBinder(), BClient.getUserId());
    ...
    static class GetIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            for (Intent intent : intents) {
                intent.setComponent(new ComponentName(BBoxCore.getHostPkg(), StubActivity.P0.class.getName()));
            }
            return method.invoke(who, args);
        }
    ...
    static class BroadcastIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Intent proxyIntent = BBoxCore.getBActivityManager().sendBroadcast(intent, resolvedType, BClient.getUserId());
            if (proxyIntent != null) {
    ...
    static class PeekService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            IBinder peek = BBoxCore.getBActivityManager().peekService(intent, resolvedType, BClient.getUserId());
            return peek;
        }
    }
