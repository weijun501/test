...
import top.gate.boxcore.client.VMCore;
...
public class IOManager {
    ...
    public void enableRedirect(Context context) {
        ...
        try {
            ApplicationInfo packageInfo = BBoxCore.getBPackageManager().getApplicationInfo(packageName, PackageManager.GET_META_DATA, BClient.getUserId());
            ...
            if (BBoxCore.getContext().getExternalCacheDir() != null && context.getExternalCacheDir() != null) {
