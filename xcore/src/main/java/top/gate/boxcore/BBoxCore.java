...
import top.gate.boxcore.client.ClientConfiguration;
import top.gate.boxcore.client.StubManifest;
import top.gate.boxcore.client.frameworks.BUserManager;
...
import top.gate.boxcore.entity.pm.InstallResult;
import top.gate.boxcore.entity.pm.InstalledModule;
import top.gate.boxcore.server.DaemonService;
...
import top.gate.boxcore.utils.ShellUtils;
import top.gate.boxcore.utils.compat.BuildCompat;
import top.gate.boxcore.utils.compat.BundleCompat;
import top.gate.boxcore.utils.compat.XposedParserCompat;
import top.gate.boxcore.utils.provider.ProviderCall;
import top.gate.boxcore.client.frameworks.BActivityManager;
import top.gate.boxcore.client.frameworks.BJobManager;
import top.gate.boxcore.client.frameworks.BPackageManager;
...
public class BBoxCore extends ClientConfiguration {
    public static final String TAG = "BlackBoxCore";
    public static int number=0;

    private static BBoxCore sBlackBoxCore = new BBoxCore();
