...
public class BEnvironment {
    private static File sVirtualRoot = new File(BBoxCore.getContext().getCacheDir().getParent(), "virtual");
    private static File sExternalVirtualRoot = BBoxCore.getContext().getExternalFilesDir("virtual");
