...
import top.gate.boxcore.client.hook.IInjectHook;
import top.gate.boxcore.client.hook.fixer.ActivityFixer;
import top.gate.boxcore.client.hook.fixer.ContextFixer;
import top.gate.boxcore.client.hook.proxies.app.HCallbackStub;
import top.gate.boxcore.utils.HackAppUtils;
...
public final class AppInstrumentation extends InstrumentationDelegate implements IInjectHook {
    ...
    public void injectHook() {
        try {
            ...
            ActivityThread.mInstrumentation.set(BBoxCore.mainThread(), this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private Instrumentation getCurrInstrumentation() {
        Object currentActivityThread = BBoxCore.mainThread();
